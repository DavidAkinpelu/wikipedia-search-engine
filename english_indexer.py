...
# modification of https://github.com/DhavalTaunk08/Wiki-Search-Engine/blob/main/english_indexer.py
...
if __name__ == '__main__':
    ...
    os.makedirs('../output_data/english_wiki_index/', exist_ok=True)
    print('parsing')
